# -*- coding: utf-8 -*-
#
# adam_awesome documentation build configuration file, created by
...
copyright = '{}, Maintainer Name'.format(datetime.utcnow().year, package.__author__)
...
# Add data for Jinja2
try:
    from adam_awesome.docs import doc_data
except:
    doc_data = dict()
